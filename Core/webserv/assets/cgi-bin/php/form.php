...
<head>
    ...
    <title>PHP CGI - Form Handler</title>
    <style>
    ...
    <div class="container">
        ...
        <?php if ($_SERVER['REQUEST_METHOD'] === 'POST'): ?>
            <div class="result">
                ...
                <p><strong>Name:</strong> <?php echo htmlspecialchars($_POST['name'] ?? 'Not provided'); ?></p>
                <p><strong>Email:</strong> <?php echo htmlspecialchars($_POST['email'] ?? 'Not provided'); ?></p>
                <p><strong>Message:</strong> <?php echo htmlspecialchars($_POST['message'] ?? 'Not provided'); ?></p>
            </div>
        <?php endif; ?>
